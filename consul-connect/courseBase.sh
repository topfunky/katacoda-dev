...
"cd ~/src && curl -L https://github.com/topfunky/katacoda-dev/raw/master/consul-connect/assets/bin/counting-service -O"
"mv ~/src/counting-service /usr/local/bin"
"cd ~/src && curl -L https://github.com/topfunky/katacoda-dev/raw/master/consul-connect/assets/bin/dashboard-service -O"
...
"runuser -l consul -c \"consul agent -dev -bind \$(echo \$SSH_CLIENT | cut -d \" \" -f1) -config-dir=/etc/consul.d >/home/consul/log/consul.log 2>&1 &\""
)
